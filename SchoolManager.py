...
class SchoolManager():
    ...
    def create_detail_widgets(self):
        ...
        self.details_name_label = customtkinter.CTkLabel(self.details_frame, text="학교명")
        self.details_name_label.grid(row=0, column=0, sticky='e')
        self.details_name_entry = customtkinter.CTkTextbox(self.details_frame, height=2)
        self.details_name_entry.grid(row=0, column=1, sticky='w')

        # Create Department label and entry field
        self.details_department_label = customtkinter.CTkLabel(self.details_frame, text="학과")
        self.details_department_label.grid(row=1, column=0, sticky='e')
        self.details_department_entry = customtkinter.CTkTextbox(self.details_frame, height=2)
        self.details_department_entry.grid(row=1, column=1, sticky='w')

        # Create Obligation label and entry field
        self.details_obligation_label = customtkinter.CTkLabel(self.details_frame, text="재직의무")
        self.details_obligation_label.grid(row=2, column=0, sticky='e')
        self.details_obligation_entry = customtkinter.CTkTextbox(self.details_frame, height=2)
        self.details_obligation_entry.grid(row=2, column=1, sticky='w')

        # Create Link label and entry field
        self.details_link_label = customtkinter.CTkLabel(self.details_frame, text="입학처 링크")
        self.details_link_label.grid(row=3, column=0, sticky='e')
        self.details_link_entry = customtkinter.CTkTextbox(self.details_frame, height=4)
        self.details_link_entry.grid(row=3, column=1, sticky='w')

        # Create Location label and entry field
        self.details_location_label = customtkinter.CTkLabel(self.details_frame, text="위치")
        self.details_location_label.grid(row=4, column=0, sticky='e')
        self.details_location_entry = customtkinter.CTkTextbox(self.details_frame, height=20)
