...
class FAQManager():
    ...
    def create_detail_widgets(self):
        self.details_title_label = tk.Label(self.details_frame, text="Title")
        self.details_title_label.grid(row=0, column=0, sticky='e')
        self.details_title_entry = tk.Text(self.details_frame, height=4)
        self.details_title_entry.grid(row=0, column=1, sticky='w')

        self.details_contents_label = tk.Label(self.details_frame, text="Contents:")
        self.details_contents_label.grid(row=1, column=0, sticky='e')
        self.details_contents_entry = tk.Text(self.details_frame, height=40)
